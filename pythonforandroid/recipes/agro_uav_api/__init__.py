...
class AgroUAVAPIRecipe(PythonRecipe):
    url = 'git+ssh:/0/0g0it@github.com/AlesavigoSoftware/agro-uav-api.git'
    # url = ProjectPathManager.join_str_paths(ProjectPathManager.get_project_dir_path(), 'Libs', 'agro-uav-api')
